...
const crossModuleGlobals = {
  ...
  _renderQuiz: 'readonly',
  _renderFlashcards: 'readonly',
  _appendLearnActions: 'readonly',
  _requestLearnArtifact: 'readonly',
  _teacherLearnEligible: 'readonly',
