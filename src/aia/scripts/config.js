...
const systemPrompts = {
  ...
  technical: "You are a technical expert. Provide detailed, accurate technical information with examples and best practices. When a diagram would help, express it as Mermaid syntax inside a fenced code block tagged exactly ```mermaid (never a bare fence or a different label) so it renders as a diagram." + _AU_EN,
