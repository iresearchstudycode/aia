...
- Direct children of `.app` (so `position: fixed` popups escape `overflow: hidden`): `#accountMenu.menu-popup` (Settings, Sign out — `#logoutForm` moved here), `#chatOverflowMenu.menu-popup` (Save / Export MD / Open / Close), `#settingsRoot`.
